...
public class RouteFollow : MonoBehaviour
{
    ...
    private IEnumerator GoByTheRoute(int routeNum)
    {
        while (routeToGo <= routes.Length - 1)
        {
            ...
            Vector3[] points = new Vector3[] { routes[routeToGo].GetChild(0).position, routes[routeToGo].GetChild(1).position, routes[routeToGo].GetChild(2).position, routes[routeToGo].GetChild(3).position };
